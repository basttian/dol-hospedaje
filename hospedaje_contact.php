...
/**
 *  \file       hospedaje_contact.php
 *  \ingroup    hospedaje
 *  \brief      Tab for contacts linked to Hospedaje
 */
...
$hookmanager->initHooks(array('hospedajecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->hospedaje->hospedaje->write;
...
$title = $langs->trans('Hospedaje')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
