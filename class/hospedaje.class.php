...
class Hospedaje extends CommonObject
{
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		/*if (! ((empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->hospedaje->write))
		 || (! empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->hospedaje->hospedaje_advance->validate))))
		 {
	...
	public function getNextNumRef()
	{
		...
		if (!empty($conf->global->HOSPEDAJE_HOSPEDAJE_ADDON)) {
			...
			foreach ($dirmodels as $reldir) {
				$dir = dol_buildpath($reldir."core/modules/hospedaje/");
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		$modelpath = "core/modules/hospedaje/doc/";
