...
/**
 *  \file       core/modules/hospedaje/doc/pdf_standard.modules.php
 *  \ingroup    hospedaje
...
/**
 *	Class to manage PDF template standard_hospedaje
 */
class pdf_standard_hospedaje extends ModelePDFHospedaje
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_HOSPEDAJE_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->hospedaje->dir_output.'/hospedaje') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->hospedaje->dir_output.'/hospedaje';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->hospedaje->dir_output.'/hospedaje/'.$objectref;
